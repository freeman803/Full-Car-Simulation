...
def launch_command():
  ...
  try:
    vianimator.api.LoadModelCmd('C:/Users/amp20/Desktop/Formula/CFR27/22/Virtual Formula/Working_Directory/VI_Racer_E_Autocross_graphics.xgr').execute()
  except:
    pass
  try:
    vianimator.api.LoadModelCmd('C:/Users/amp20/Desktop/Formula/CFR27/22/Virtual Formula/Working_Directory/VI_Racer_E_Autocross_road_graphics.xgr').execute()
  except:
    pass
  ...
  trackview.setGraphicFile('mdids://VI_Racer/driver_roads.tbl/RaceTrack.drd')
  ...
  viframework.viobjects.simulation.Analysis.setSourceFile(analysis_manager.getAnalysis(modelName),'VI_Racer_E_Autocross.res')
launch_command()
