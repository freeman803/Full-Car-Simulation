...
def launch_command():
  ...
  try:
    vianimator.api.LoadModelCmd('C:/Users/amp20/Desktop/Formula/CFR27/22/Virtual Formula/Working_Directory/CFR27_c1_step_graphics.xgr').execute()
  except:
    pass
  try:
    vianimator.api.LoadModelCmd('C:/Users/amp20/Desktop/Formula/CFR27/22/Virtual Formula/Working_Directory/CFR27_c1_step_road_graphics.xgr').execute()
  except:
    pass
  ...
  viframework.viobjects.simulation.Analysis.setSourceFile(analysis_manager.getAnalysis(modelName),'CFR27_c1_step.res')
launch_command()
